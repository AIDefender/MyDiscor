...
#        logger.save_itr_params(epoch, snapshot)
        ...
        self.replay_buffer.end_epoch(epoch, self.save, self.log_name)
        self.small_buffer.end_epoch(epoch)
    ...
    def _get_snapshot(self):
        ...
        for k, v in self.small_buffer.get_snapshot().items():
            snapshot['small_buffer/' + k] = v
        return snapshot
